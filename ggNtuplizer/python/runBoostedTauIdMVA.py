...
class BoostedTauIDEmbedder(object):
	...
	def runTauID(self, name='NewBoostedTauIDsEmbedded'):
	#	self.process.rerunBoostedMvaIsolationSequence = self.cms.Sequence()
		...
		self.process.NewBoostedTauIDsEmbedded = embedID
